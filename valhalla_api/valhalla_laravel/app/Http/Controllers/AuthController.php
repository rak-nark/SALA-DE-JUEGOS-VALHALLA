...
public function update(Request $request, $idCliente)
{
    ...
    $validacion = Validator::make($request->all(), [
        ...
        'apellidoCliente' => 'required|min:2|max:40',
        'correoCliente' => 'required|email',
        'contrasenaCliente' => 'nullable|string|min:6|max:40'
    ]);
    ...
    // Solo actualizar la contraseña si el usuario envía una nueva
    if ($request->filled('contrasenaCliente')) {
        $cliente->contrasenaCliente = bcrypt($request->contrasenaCliente);
    }
