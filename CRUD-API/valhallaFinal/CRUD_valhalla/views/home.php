...
<div class="wrapper">
        ...
        <div class="sidebar" id="sidebar">
            <ul>
                <li><a href="home.php"title="Gestiòn usuarios"><i class="fa-solid fa-circle-user"></i><span class="menu-text">Gestión Clientes</span></a></li>
    ...
    <!-- Modal de Edición -->
<div class="modal fade" id="editModal_<?php echo $fila['idCliente']; ?>" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post">
                    ...
                    <div class="mb-3">
                        <label for="nombreCliente_<?php echo $fila['idCliente']; ?>" class="form-label">Nombre</label>
                        <input type="text" name="nombreCliente" class="form-control" id="nombreCliente_<?php echo $fila['idCliente']; ?>" value="<?php echo $fila['nombreCliente']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="apellidoCliente_<?php echo $fila['idCliente']; ?>" class="form-label">Apellido</label>
                        <input type="text" name="apellidoCliente" class="form-control" id="apellidoCliente_<?php echo $fila['idCliente']; ?>" value="<?php echo $fila['apellidoCliente']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="correoCliente_<?php echo $fila['idCliente']; ?>" class="form-label">Correo</label>
                        <input type="email" name="correoCliente" class="form-control" id="correoCliente_<?php echo $fila['idCliente']; ?>" value="<?php echo $fila['correoCliente']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="contrasenaCliente_<?php echo $fila['idCliente']; ?>" class="form-label">Contrasena</label>
                        <input type="password" name="contrasenaCliente" class="form-control" id="contrasenaCliente_<?php echo $fila['idCliente']; ?>" value="">
                    </div>
                    <div class="mb-3">
                        <label for="rol_<?php echo $fila['idCliente']; ?>" class="form-label">Rol</label>
                        <select name="rol" class="form-control" id="rol_<?php echo $fila['idCliente']; ?>">
                            <option value="usuario" <?php echo ($fila['rol'] == 'usuario' || $fila['rol'] == null) ? 'selected' : ''; ?>>Usuario</option>
            ...
            if (empty($res)) {
                ...
                foreach ($res as $fila) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $fila['contrasenaCliente']; ?></td>
                        <td>
                            ...
                            <form action="" method="post" style="display:inline;">
                                <input type="hidden" name="idCliente" value="<?php echo $fila['idCliente']; ?>">
                                <!-- Botón Editar -->
                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editModal_<?php echo $fila['idCliente']; ?>">
                                    Editar
                                </button>
                            </form>
                        </td>
