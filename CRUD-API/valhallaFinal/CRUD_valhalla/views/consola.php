...
/* Navbar */
.navbar {
    background-color: rgba(83, 128, 131, 0.7);
    color: white;
    padding: 1rem;
    display: flex;
...
.submenu-content {
    ...
    right: 0;
    top: 100%;
    background-color: #89909f; /* Color oscuro para el submenu */
...
/* Botones de modal */
.btn-primary {
    background-color: #2a7f62; /* Color principal oscuro */
    border: none;
    border-radius: 8px;
...
.btn-primary:hover {
    background-color: ##1d5a48; /* Color en hover */
...
.form-control:focus {
    border-color: #1a4d3e;
    box-shadow: 0 0 5px rgba(26, 77, 62, 0.5);
}
/* Estilos de modales */
.modal-content {
    border-radius: 8px;
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td><?php echo ($res[2] == 1) ? 'Disponible' : 'No disponible'; ?></td>
                        <td>
                    ...
                    <!-- Modal de edición -->
                    <div class="modal fade" id="editModal_<?php echo $res[0]; ?>" tabindex="-1" aria-labelledby="editModalLabel_<?php echo $res[0]; ?>" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="editModalLabel_<?php echo $res[0]; ?>">Editar Consola</h5>
                                ...
                                <div class="modal-body">
                                    <form method="post">
                                        <input type="hidden" name="id" value="<?php echo $res[0]; ?>">
                                        <div class="mb-3">
                                            <label for="tipo_<?php echo $res[0]; ?>" class="form-label">Tipo</label>
                                            <input type="text" name="tipo" class="form-control" id="tipo_<?php echo $res[0]; ?>" value="<?php echo $res[1]; ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label for="disponibilidad_<?php echo $res[0]; ?>" class="form-label">Disponibilidad</label>
                                            <select name="disponibilidad" class="form-control" id="disponibilidad_<?php echo $res[0]; ?>">
                                                <option value="1" <?php echo ($res[2] == 1) ? 'selected' : ''; ?>>Disponible</option>
                                                <option value="0" <?php echo ($res[2] == 0) ? 'selected' : ''; ?>>No disponible</option>
                                            </select>
                                        </div>
