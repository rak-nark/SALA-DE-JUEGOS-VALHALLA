...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-03-2025 a las 22:46:18
...
(2, 'Pedrito', 'Navajas', 'pedritonavaja@gamil.com', '$2y$10$ewbOutE8dXri30tHFA4EAuaWlNIROrmsPp8/Qyf4jFTvoQhdfGIjm', 'administrador'),
...
(30, 'pedrito', 'perezz', 'pepes@gmail.com', '$2y$10$tMYiaZ7kHCtmIEtoAxWAquX.vXnaGt5bboian71AQkhpImJ4eBkSa', 'usuario'),
(31, 'pedrito', 'perezz', 'pepes@gmail.co', '$2y$10$Rn5mYfAlO/g6rKshI71RJu7maq6ycL8nSn5F99uyjn0b4lx/dMLTC', 'usuario'),
...
(48, 'miguel angel', 'suarezz', 'miguelito@gmail.com', '$2y$10$X/jZpsuTJ9q1ARM0tvwWeuGPwX/RhobSX.viAYCiF9Ztd0WpUnhJa', 'usuario');
...
CREATE TABLE `debug_trigger` (
  ...
  `tipoConsola` varchar(10) DEFAULT NULL,
  `minutos` int(11) DEFAULT NULL,
  `precio` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `debug_trigger`
--

INSERT INTO `debug_trigger` (`id`, `idPrestamo`, `idConsola`, `tipoConsola`, `minutos`, `precio`) VALUES
(1, 55, 2, '', 180, 0),
(2, 56, 3, 'Antes del ', 0, 0),
(3, 56, 3, '', 0, 0),
(4, 56, 3, '', 120, 0),
(5, 57, 1, 'Antes del ', 0, 0),
(6, 57, 1, '', 0, 0),
(7, 57, 1, 'Error: tip', 180, 0),
(8, 57, 1, '', 180, 0);
...
(5, '2024_11_13_150827_create_clientes_table', 1);
...
(91, 'App\\Models\\clienteModelo', 48, 'auth_token', 'ab9e4cec4ec28f43dafe5555991146cdae051ede042ba3b65626062507c5b26c', '[\"*\"]', NULL, NULL, '2025-03-20 00:22:12', '2025-03-20 00:22:12'),
(92, 'App\\Models\\clienteModelo', 48, 'nombre-del-token', 'bef9f0cc7fecf85dd5f9d63abf3ebcbad5476b31802a6958a5be9f9ac4963c3d', '[\"*\"]', '2025-03-20 00:27:23', NULL, '2025-03-20 00:23:53', '2025-03-20 00:27:23'),
(93, 'App\\Models\\clienteModelo', 42, 'nombre-del-token', '8a0b414a10478a2ce9d30437877a1ace5ee283289e68bb118ddfe315a1f98ebf', '[\"*\"]', '2025-03-20 00:27:45', NULL, '2025-03-20 00:27:43', '2025-03-20 00:27:45'),
(94, 'App\\Models\\clienteModelo', 42, 'nombre-del-token', '3d607073b446cc39154218bcc2e5bb4970943aa46b380ad82b7dcc53ad62ddfa', '[\"*\"]', '2025-03-20 02:46:15', NULL, '2025-03-20 02:42:53', '2025-03-20 02:46:15'),
(95, 'App\\Models\\clienteModelo', 48, 'nombre-del-token', '601ae55af6e694790d5512122f62470e44a9fbd3ece8b7d6f8fd9ebb707d1527', '[\"*\"]', '2025-03-20 02:51:06', NULL, '2025-03-20 02:50:48', '2025-03-20 02:51:06'),
(96, 'App\\Models\\clienteModelo', 42, 'nombre-del-token', '9b45d2ff285bd988c5ac7028e37d3070564e423d552e60f788c304457eac4338', '[\"*\"]', NULL, NULL, '2025-03-26 00:13:43', '2025-03-26 00:13:43'),
(97, 'App\\Models\\clienteModelo', 42, 'nombre-del-token', 'c3437e06199a6d995fd16ffe81c349ad71994a41bd7e9b0f7b371889acf1d2be', '[\"*\"]', '2025-03-26 00:14:06', NULL, '2025-03-26 00:13:44', '2025-03-26 00:14:06');
...
(2, '2024-08-19', '14:10:00', 90, 1, 1, 8),
...
(14, '2024-12-12', '12:30:00', 120, 1, 32, 13),
(15, '2024-12-10', '11:00:00', 30, 1, 26, 8),
(16, '2024-12-10', '10:30:00', 90, 1, 32, 12),
...
(54, '2025-03-19', '12:00:00', 180, 0, 44, 9),
...
(63, '2025-03-20', '17:00:00', 60, 1, 48, 13),
(66, '2025-03-21', '16:00:00', 60, 1, 42, 12),
(67, '2025-03-19', '16:00:00', 30, 0, 42, 3),
(68, '2025-03-19', '16:00:00', 90, 1, 48, 4),
(71, '2025-03-19', '17:00:00', 30, 0, 25, 12),
(72, '2025-03-19', '17:00:00', 30, 0, 25, 3),
(73, '2025-03-19', '17:00:00', 90, 0, 25, 1),
(74, '2025-03-21', '14:38:00', 90, 0, 25, 1),
(75, '2025-03-21', '14:47:00', 180, 0, 25, 8),
(76, '2025-03-21', '14:53:00', 60, 0, 25, 7),
(77, '2025-03-21', '14:44:00', 30, 0, 25, 8),
(78, '2025-03-25', '14:00:00', 60, 1, 42, 10),
(79, '2025-03-25', '14:32:00', 30, 0, 25, 3);
...
(23, '2025-03-19', 1500, 63),
(24, '2025-03-21', 8500, 66),
(25, '2025-03-19', 1500, 67),
(26, '2025-03-19', 3000, 68),
(27, '2025-03-19', 1500, 71),
(28, '2025-03-19', 1500, 72),
(29, '2025-03-19', 3000, 73),
(30, '2025-03-21', 3000, 74),
(31, '2025-03-21', 7500, 75),
(32, '2025-03-21', 2500, 76),
(33, '2025-03-21', 1500, 77),
(34, '2025-03-25', 3000, 78),
(35, '2025-03-25', 1500, 79);
...
--
ALTER TABLE `cliente`
  MODIFY `idCliente` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `prestamo`
  MODIFY `idPrestamo` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
