                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <button class="btn btn-sm btn-info" 
                                                                ...
                                                                data-id_consola="<?php echo $m['id_consola']; ?>"
                                                                data-descripcion="<?php echo htmlspecialchars($m['descripcion']); ?>"
                                                                data-estado="<?php echo getEstadoTexto($m['estado'], $m['fecha_programada']); ?>"
                                                                data-fecha_programada="<?php echo date('d/m/Y', strtotime($m['fecha_programada'])); ?>"
                                                                data-created_at="<?php echo date('d/m/Y H:i', strtotime($m['created_at'])); ?>"
                                                                data-fecha_inicio="<?php echo $m['fecha_inicio'] ? date('d/m/Y H:i', strtotime($m['fecha_inicio'])) : 'N/A'; ?>"
                                                                data-fecha_fin="<?php echo $m['fecha_fin'] ? date('d/m/Y H:i', strtotime($m['fecha_fin'])) : 'N/A'; ?>"
                                                                title="Detalles">
