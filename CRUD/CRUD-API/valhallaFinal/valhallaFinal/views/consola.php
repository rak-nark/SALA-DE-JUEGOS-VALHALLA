                    ...
                    <div class="modal-body">
                        <form method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="disponibilidad" class="form-control" id="exampleInputText1" max="1">
                            </div>
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="modal fade" id="editModal_<?php echo $res[0]; ?>" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="editModalLabel">Editar Consola</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form method="post">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="disponibilidad" class="form-control" id="disponibilidad_<?php echo $res[0]; ?>" value="<?php echo $res[2]; ?>">
                                                            </div>
